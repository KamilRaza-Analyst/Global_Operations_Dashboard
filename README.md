Global Operations & Workflow Analysis Dashboard

📌 Project Overview    
This project focuses on analyzing global workforce efficiency and identifying operational bottlenecks across four key regions (AMER, EMEA, APAC, and LATAM). Using a dataset of over 24 hours of logs, I developed an interactive dashboard to track Service Levels and Agent Productivity, followed by a strategic "Executive Report" to improve staffing during peak volatility.                                                            
🚀 Key FeaturesInteractive Dashboard: 
Real-time filtering by Region, Business Unit, and Channel using Slicers.                                     
Automated KPIs: Dynamic calculation of Service Level (SL), Average Wait Time (AWT), and Operations Index.    
Strategic Insights: A dedicated analysis sheet identifying high-impact areas for business optimization.         
...
📂 Files in this Repository
 Global_Operations_Dashboard_KamilRaza.xlsx: The full interactive Excel tool (Download to view functionality).                                                                     
 Project_Report_Kamil.pdf: A 3-page consolidated report including documentation and the final dashboard view.
